...
(function() {
  ...
  function initModals() {
    ...
    document.querySelectorAll('[data-dismiss="modal"]').forEach(function(dismissBtn) {
  ...
  function initTabs() {
    document.querySelectorAll('[data-toggle="tab"]').forEach(function(trigger) {
      ...
      trigger.addEventListener('click', function(e) {
        ...
        const tabList = trigger.closest('[role="tablist"]') || trigger.closest('.nav-tabs');
        if (tabList) {
   ...
   */
  function initAlerts() {
    document.querySelectorAll('[data-dismiss="alert"]').forEach(function(dismissBtn) {
